...
function mergeContent(content) {
  ...
  return {
    ...
    professionalProfile: {
      ...
      professionalLabel:
        content.professionalProfile.professionalLabel ||
        fallbackContent.professionalProfile.professionalLabel,
      validationItems:
    ...
    contactSettings: {
      ...
      bookingPolicy: {
        ...fallbackContent.contactSettings.bookingPolicy,
        ...(content.contactSettings?.bookingPolicy || {}),
      },
