export const fallbackContent = {
  ...
  seoSettings: {
    metaTitle: "Psicoterapia psicoanalítica en línea | Citas",
    metaDescription:
      "Conoce la propuesta de psicoterapia psicoanalítica en línea para adolescentes, adultos y parejas, y solicita información para una primera cita.",
    ogImage: null,
    ogImageAlt: "",
